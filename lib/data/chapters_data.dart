...
const List<Chapter> panjsurahChapters = [
  ...
  Chapter(id: 'ps_fatah', titleUrdu: 'سورۂ الفتح', titleEnglish: 'Surah Al-Fath', icon: '🏆', source: ContentSource.panjsurah, folderName: 'fatah', totalPngPages: 11, isTextOnly: true),
  ...
  Chapter(id: 'ps_baqrah', titleUrdu: 'سورۂ البقرة (آخری آیات)', titleEnglish: 'Surah Al-Baqarah (Last Verses)', icon: '🐄', source: ContentSource.panjsurah, folderName: 'baqrah', totalPngPages: 2, isTextOnly: true),
  ...
  Chapter(id: 'ps_darood', titleUrdu: 'درود شریف', titleEnglish: 'Darood Shareef', icon: '✨', source: ContentSource.panjsurah, folderName: 'darood', totalPngPages: 4, isTextOnly: true),
